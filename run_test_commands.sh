...
python merginguriel/aggregate_results.py --results-dir testing_chamber/results --verbose

echo "=== Generating plots ==="
python merginguriel/plot_results.py --results-dir testing_chamber/results --plots-dir testing_chamber/plots
