...
def main():
    ...
    # For consistency with evaluation, use LABEL_0, LABEL_1 format in id2label
    # This ensures the evaluation function can handle all models consistently
    label_to_id = {v: i for i, v in enumerate(label_list)}
    id2label = {i: f'LABEL_{i}' for i in range(len(label_list))}
