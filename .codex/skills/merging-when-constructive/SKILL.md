...
3. ~~Can we predict Merging Effect without running the full merge?~~ → **PARTIALLY ANSWERED**: TV Cosine provides weak signal (+0.3%), but not strong enough to flip outcomes
